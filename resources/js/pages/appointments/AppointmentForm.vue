...
const handleSubmit=(values,actions)=>{
    ...
    if(editMode.value){
        ...
        createAppoinntment(values,actions);
...
const createAppoinntment=(values,actions)=>{
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input v-model="form.start_time" type="text" class="form-control flatpickr" id="start-time" :class="{'is-invalid':errors.start_time}">
